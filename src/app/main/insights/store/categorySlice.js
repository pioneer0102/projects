...
export const selectOrderStatistics = ({ insightsApp }) =>
    insightsApp.category.orderStatistics;
export const selectSaleStatistics = ({ insightsApp }) =>
    insightsApp.category.saleStatistics;
export const selectSaleTotalByCategory = ({ insightsApp }) =>
    insightsApp.category.saleTotalByCategory;
export const selectOrderTotalByCategory = ({ insightsApp }) =>
    insightsApp.category.orderTotalByCategory;
